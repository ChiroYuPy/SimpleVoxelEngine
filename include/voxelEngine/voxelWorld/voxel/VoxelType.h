...
namespace voxel {
    ...
    struct VoxelTypeDefinition {
        ...
        [[nodiscard]] bool isSolid() const noexcept {
            return !properties.isLiquid && renderMode != RenderMode::INVISIBLE;
        }
    ...
    public:
        ...
        VoxelBuilder &name(std::string_view n) {
            definition_.displayName = n;
            return *this;
        }

        VoxelBuilder &color(const glm::vec4 &c) {
            definition_.color = c;
            return *this;
        }

        VoxelBuilder &color(float r, float g, float b, float a = 1.0f) {
            definition_.color = glm::vec4(r, g, b, a);
            return *this;
        }

        VoxelBuilder &renderMode(RenderMode mode) {
            definition_.renderMode = mode;
            return *this;
        }

        VoxelBuilder &collision(bool hasCollision) {
            definition_.properties.hasCollision = hasCollision;
            return *this;
        }

        VoxelBuilder &liquid(bool isLiquid = true) {
            definition_.properties.isLiquid = isLiquid;
            return *this;
        }
        ...
        VoxelBuilder &transparent() {
            definition_.renderMode = RenderMode::TRANSPARENT;
            return *this;
        }

        VoxelBuilder &opaque() {
            definition_.renderMode = RenderMode::OPAQUE;
            return *this;
        }

        VoxelBuilder &invisible() {
            definition_.renderMode = RenderMode::INVISIBLE;
            return *this;
        }
